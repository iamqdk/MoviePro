...
namespace MoviePro.Controllers
{
    public class CountriesController : Controller
    {
        ...
        {
            ViewBag.Count = _context.Countries.Count();
            return View(await _context.Countries.Take(5).ToListAsync());
        }
        public async Task<IActionResult> IndexPage(int page)
        {
            ...
            ViewBag.page = page;
            ViewBag.Count = _context.Countries.Count();
            return View("Index", await _context.Countries.Skip(page * 5).Take(5).ToListAsync());
        }
